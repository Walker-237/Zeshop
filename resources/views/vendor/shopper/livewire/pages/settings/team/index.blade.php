<x-shopper::container>
    @php
        $roles = \Shopper\Core\Models\Role::query()
            ->with('users')
            ->orderBy('created_at')
            ->get();
    @endphp
    ...
    <x-shopper::heading class="my-6" :title="__('staff & permissions')" />
    ...
    <div class="mt-10 space-y-12 pb-10">
                    ...
                    >
                        ...
                        <div>
                            <h3 class="mt-4 text-lg font-medium leading-6 text-gray-900 dark:text-white">
                                {{ $role->name === config('shopper.core.users.default_role') ? 'Customers' : $role->display_name }}
                            </h3>
        ...
        <div class="space-y-6">
            ...
            >
                ...
                <div>
                    <x-shopper::buttons.primary :link="route('shopper.settings.users.create')">
